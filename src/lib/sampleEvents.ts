...
export const SAMPLE_EVENTS: Event[] = [
  ...
  // ── 4월 (지난 행사 · 투표 샘플) ─────────────────────────
  {
    ...
    impact: 5,
    impact_basis: '전국 팬 원정 + 공연장 인근 조기 매진 가능',
  ...
  // ── 3월 (지난 행사) ──────────────────────────────────────
  {
    ...
    expected_visitors: 30000,
    impact: 4,
    impact_basis: '새벽 출발 특성 + 전국 참가자 전날 숙박',
  ...
  // ── 4~6월 (한강 드론 라이트쇼 — 5회차 개별 날짜) ──────────
  {
    ...
    expected_visitors: 30000,
    impact: 2,
    impact_basis: '당일 방문 위주이나 여의도 인파 증가',
  ...
  },
  {
    ...
    expected_visitors: 30000,
    impact: 2,
    impact_basis: '관광객 유입 있으나 체류형은 아님',
  ...
  // ── 8~9월 ────────────────────────────────────────────────
  {
    ...
    expected_visitors: 15000,
    impact: 5,
    impact_basis: 'KSPO권 숙박 수요 폭증 가능',
